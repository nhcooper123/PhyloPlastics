...
```{r}
# Read in tree
tree.seabird <- read.nexus(here::here("data/seabird-tree-Claramont2025_2025-09-11.nex"))

# Look at it
str(tree.seabird) # should have 385 tips
...
data0.1 <- read_csv(here::here("data-raw/trait-data-2025-09-12.csv"))
data0.2 <- read_csv(here::here("data-raw/plastic-ingestion-data-2025-09-12.csv"))
...
data2_joined <- data0.2 |> 
  left_join(data0.1, by = "Clements2024_Binomial")
```
...
data2_tips <-
  data2_binary %>%
  mutate(tips = gsub(" ", "_", data2_binary$Clements2024_Binomial))
```
