...
2. is_freeflying has a lot of missing data where it was not specified whether birds were freeflying or nestbound. We don't want to lose all this data so we're going to fit 
